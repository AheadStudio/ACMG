...
jcf.addModule(function($, window) {
	...
	function ComboBox(options) {
		this.options = $.extend({
			...
			flipDropToFit: true,
			maxVisibleItems: 10,
			fakeAreaStructure: '<span class="jcf-select"><span class="jcf-select-placeholder"></span><span class="jcf-select-text"></span><span class="jcf-select-opener"></span></span>',
	...
	$.extend(SelectList.prototype, {
		...
		createOptionsList: function(container) {
			...
			if ($(list).find(".jcf-option-hide").length !== 0)  {
				$(list).find(".jcf-option-hide").parent().addClass("hide");
			}
			return list;
		},
		refresh: function() {
